...
namespace dotnetprojekt.Migrations
{
    ...
    [Migration("20250511134955_AddPreferredRegionsUserPreference")]
    partial class AddPreferredRegionsUserPreference
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("dotnetprojekt.Models.ExperienceLevel", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
            ...
            modelBuilder.Entity("dotnetprojekt.Models.LoginHistory", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
                    ...
                    b.HasIndex("LoginTime")
                        .HasDatabaseName("idx_loginhistory_logintime");

                    b.HasIndex("UserId")
                        .HasDatabaseName("idx_loginhistory_userid");
            ...
            modelBuilder.Entity("dotnetprojekt.Models.TopRatedWinesView", b =>
                {
                    ...
                    b.ToView("mv_top_rated_wines", (string)null);
                });
            ...
            modelBuilder.Entity("dotnetprojekt.Models.UserPreference", b =>
                {
                    ...
                    b.PrimitiveCollection<int[]>("PrefferedRegions")
                        .IsRequired()
                        .HasColumnType("integer[]");
            ...
            modelBuilder.Entity("dotnetprojekt.Models.User", b =>
                {
                    b.HasOne("dotnetprojekt.Models.ExperienceLevel", null)
                        .WithMany("Users")
                        .HasForeignKey("ExperienceLevelId");

                    b.HasOne("dotnetprojekt.Models.ExperienceLevel", "ExperienceLevel")
                        .WithMany()
